...
from collections import deque, Hashable, Sequence
...
class zip(Stream):
    ...
    def __init__(self, *upstreams, **kwargs):
        ...
        print(upstreams)
        print([isinstance(upstream, Stream) for upstream in upstreams])
        print([type(upstream) for upstream in upstreams])
...
def move_to_first(node, first):
    if first is True:
        first = node.upstreams
